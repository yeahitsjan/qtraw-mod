...
/******************************************************************************************************
@yeahitsjan
Why did I disable this? At the moment we want to have fast results, so we disabled full Raw image
loading. This means the reimplemented read function below, only loads the thumbnail out of the image.
This results in higher load times.

TODO: add some point implement a way of how to choose via code which type of image is needed...
******************************************************************************************************/
